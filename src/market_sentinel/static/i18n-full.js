...
(() => {
  ...
  const phrases = {
    en: {
      ...
      'PODE ACONTECER': 'MAY HAPPEN', 'PREÇO ATUAL': 'CURRENT PRICE', 'GATILHO': 'TRIGGER', 'CLIQUE PARA ABRIR O GRÁFICO': 'CLICK TO OPEN CHART',
    ...
    es: {
      ...
      'PODE ACONTECER': 'PUEDE OCURRIR', 'PREÇO ATUAL': 'PRECIO ACTUAL', 'GATILHO': 'DISPARADOR', 'CLIQUE PARA ABRIR O GRÁFICO': 'HAZ CLIC PARA ABRIR EL GRÁFICO', 'Estimativa de prontidão técnica': 'Estimación de preparación técnica',
